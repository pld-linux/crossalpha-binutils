...
Summary(es):	Utilitarios para desarrollo de binarios de la GNU - ALPHA binutils
Summary(fr):	Utilitaires de développement binaire de GNU - ALPHA binutils
Summary(pl):	Skro¶ne narzêdzia programistyczne GNU dla ALPHA - binutils
...
Ten pakiet zawiera wersjê skro¶n± generuj±c± kod dla ALPHA.
